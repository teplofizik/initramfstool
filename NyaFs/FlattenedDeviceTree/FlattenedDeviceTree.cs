...
using NyaFs.ImageFormat.Dtb.Types;
using System;
...
{
    public class FlattenedDeviceTree : RawPacket
    {
        // https://devicetree-specification.readthedocs.io/en/v0.2/flattened-format.html
        // https://wiki.freebsd.org/FlattenedDeviceTree
        // 
        public FlattenedDeviceTree(string Filename) : this(System.IO.File.ReadAllBytes(Filename))
        {

        }

        public FlattenedDeviceTree(byte[] Data) : base(Data)
        {
        ...
        public Node Read()
        {
            ...
            var Address = OffsetDtStruct;

            // Start parser:
            ProcessNode(Root, Address);
        ...
        /// </summary>
        public uint Magic => ReadUInt32BE(0x0);
        ...
        /// </summary>
        public uint MemReserveMap => ReadUInt32BE(0x10);
        ...
        /// </summary>
        public uint Version => ReadUInt32BE(0x14);
        ...
        /// </summary>
        public uint LastCompatibleVersion => ReadUInt32BE(0x18);
        ...
        /// </summary>
        public FdtReserveEntry[] ReserveMemory
        {
            get
            {
                List<FdtReserveEntry> fdtReserveEntries = new List<FdtReserveEntry>();
                ...
                {
                    fdtReserveEntries.Add(new FdtReserveEntry(RegAddress, RegSize));
        ...
        public class FdtReserveEntry
        {
            public ulong Address;
            public ulong Size;

            public FdtReserveEntry(ulong Address, ulong Size)
            {
